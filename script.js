document.addEventListener("keydown", (event) => {
  ...
  if (key == 65) {
    var audio = new Audio("music/Piano Chord 208.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 83) {
    var audio = new Audio("music/Piano Chord 209.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 68) {
    var audio = new Audio("music/Piano Chord 331.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 70) {
    var audio = new Audio("music/Drum Sticks Hit 3.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 71) {
    var audio = new Audio("music/Drum Snare Roll.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 72) {
    var audio = new Audio("music/PREL Musical 57.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 74) {
    var audio = new Audio("music/Cymbal Suspended 2.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 75) {
    var audio = new Audio("music/Musical Compos 33.mp3");
    audio.currentTime = 0;
    audio.play();
  ...
  if (key == 76) {
    var audio = new Audio("music/Musical Orches 4.mp3");
    audio.currentTime = 0;
    audio.play();
